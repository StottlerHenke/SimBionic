...
public class CategorySAXWriter  {
  ...
  **/
  ...
  public static void write (com.stottlerhenke.simbionic.common.xmlConverters.model.Category dmObject, PrintWriter writer, int indent) {
   
     Utils.writeField(CategorySAXReader.name,dmObject.getName(),writer,indent+1);
     List<com.stottlerhenke.simbionic.common.xmlConverters.model.Descriptor>  descriptors = (List<com.stottlerhenke.simbionic.common.xmlConverters.model.Descriptor>)dmObject.getDescriptors();
      if (descriptors != null && !descriptors.isEmpty()) {
        Utils.writeStartTag(CategorySAXReader.descriptors,writer,indent+1);
        DescriptorGroupSAXWriter.write(descriptors, writer,indent+2);
        Utils.writeEndTag(CategorySAXReader.descriptors,writer,indent+1);
      }
      
     Utils.writeField(CategorySAXReader.selected,dmObject.isSelected(),writer,indent+1);
