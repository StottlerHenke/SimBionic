...
public class PredicateSAXWriter  {
  ...
  **/
  ...
  public static void write (com.stottlerhenke.simbionic.common.xmlConverters.model.Predicate dmObject, PrintWriter writer, int indent) {
   
     Utils.writeField(PredicateSAXReader.name,dmObject.getName(),writer,indent+1);
     
     Utils.writeField(PredicateSAXReader.description,dmObject.getDescription(),writer,indent+1);
     
     Utils.writeField(PredicateSAXReader.returnType,dmObject.getReturnType(),writer,indent+1);
     
     Utils.writeField(PredicateSAXReader.core,dmObject.isCore(),writer,indent+1);
     List<com.stottlerhenke.simbionic.common.xmlConverters.model.Parameter>  parameters = (List<com.stottlerhenke.simbionic.common.xmlConverters.model.Parameter>)dmObject.getParameters();
      if (parameters != null && !parameters.isEmpty()) {
        Utils.writeStartTag(PredicateSAXReader.parameters,writer,indent+1);
        ParameterGroupSAXWriter.write(parameters, writer,indent+2);
        Utils.writeEndTag(PredicateSAXReader.parameters,writer,indent+1);
      }
