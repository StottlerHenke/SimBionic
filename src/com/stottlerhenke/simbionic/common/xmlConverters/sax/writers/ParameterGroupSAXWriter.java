...
public class ParameterGroupSAXWriter  {

 /** 
  * Writes an array of TG objects to xml 
  *
 **/
 public static void write (List<com.stottlerhenke.simbionic.common.xmlConverters.model.Parameter> dmObjects, PrintWriter writer, int indent) {
