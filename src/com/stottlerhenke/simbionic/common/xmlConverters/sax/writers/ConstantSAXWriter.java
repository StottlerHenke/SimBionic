...
public class ConstantSAXWriter  {
  ...
  **/
  ...
  public static void write (com.stottlerhenke.simbionic.common.xmlConverters.model.Constant dmObject, PrintWriter writer, int indent) {
   
     Utils.writeField(ConstantSAXReader.name,dmObject.getName(),writer,indent+1);
