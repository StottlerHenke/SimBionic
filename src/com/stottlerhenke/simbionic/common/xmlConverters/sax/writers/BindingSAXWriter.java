...
public class BindingSAXWriter  {
  ...
  **/
  ...
  public static void write (com.stottlerhenke.simbionic.common.xmlConverters.model.Binding dmObject, PrintWriter writer, int indent) {
   
     Utils.writeField(BindingSAXReader.var,dmObject.getVar(),writer,indent+1);
     
     Utils.writeField(BindingSAXReader.expr,dmObject.getExpr(),writer,indent+1);
