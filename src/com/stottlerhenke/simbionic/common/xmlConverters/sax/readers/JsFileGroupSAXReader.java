...
public class JsFileGroupSAXReader extends Parser {


  /** sequence ,minOccurs=0, type=xsd:string **/
  public static String jsFile = "jsFile";
   /** id to refer to internally refer to the jsFile tag **/
  public static int jsFile_ID = 1;
  ...
  /** constructor **/
  public JsFileGroupSAXReader (StackParser stackParserController,String tag, Hashtable tagAttributes, Parser client, int property) {
