...
public class IndexGroupSAXReader extends Parser {


  /** sequence ,minOccurs=0, type=xsd:string **/
  public static String index = "index";
   /** id to refer to internally refer to the index tag **/
  ...
  /** constructor **/
  public IndexGroupSAXReader (StackParser stackParserController,String tag, Hashtable tagAttributes, Parser client, int property) {
