...
public class GlobalGroupSAXReader extends Parser {


  /** sequence ,minOccurs=0, type=Global **/
  ...
  List<com.stottlerhenke.simbionic.common.xmlConverters.model.Global> readObjects;

    
  /** constructor **/
  public GlobalGroupSAXReader (StackParser stackParserController,String tag, Hashtable tagAttributes, Parser client, int property) {
     super(stackParserController,client,property);
	 readObjects = new   ArrayList<com.stottlerhenke.simbionic.common.xmlConverters.model.Global> ();
	 startTag = tag;
	 startTagAttributes = tagAttributes;
  }
   
  /** returns array of objects read by the parser **/
  public List<com.stottlerhenke.simbionic.common.xmlConverters.model.Global> getValue () {
	  return readObjects;
  }
 ...
 /** given the start of a tag create a parser to transform the content of the tag into a DM object**/
  ...
  protected  void receiveParsingResult(int property, Object result) {
   try{
  	...
  	readObjects.add((com.stottlerhenke.simbionic.common.xmlConverters.model.Global)result);
   }
    catch(Exception e){
    	e.printStackTrace();
    }
